...
<head>
    ...
    <meta charset="UTF-8">
    <title>U闲交易平台</title>
	<link rel="stylesheet" type="text/css" href="front/css/xiangqing.css">
    ...
    <div class="xiangqing wrap clearfix">
        <div class="fl">
            <div class="xiangqing_img">
                <img width="300px" height="300px" src="idleimg/${map.idleimg}">
            </div>
                <ul class="bbjs">
                    <li>宝贝介绍</li>
                </ul>
        ...
        <div class="xiangqing_right fr">
            ...
            <ul class="price">
                ...
                <li>成　　色：${map.percentage }</li>
                <li>所  在  地：${map.location }</li>
                
            </ul>
            <a href="ConfirmOrder?id=${map.id}" target="_blank" class="xingqing_buy">立即购买</a>
            <div class="danbao">
