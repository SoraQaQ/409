...
<form>
	<div class="formbody">
		...
		<ul class="forminfo">
			...
			<li>
				<label>新密码</label>
				<input id="pwd1" readonly="readonly" name="pwd1" type="password" class="dfinput" />
				<i></i>
			</li>
			<li>
				<label>确认密码</label>
				<input  onblur="checkSamePwd()" id="pwd2" readonly="readonly" name="" type="password" class="dfinput" />
				<i></i>
			</li>
